...
if(WEBRTC_INCLUDE_DIR)
  ...
  elseif(CMAKE_SYSTEM_NAME STREQUAL "Darwin")
    ...
    find_library(CORE_SERVICES CoreService)
    find_library(CORE_MEDIA CoreMedia)
    find_library(FOUNDATION Foundation)
    set(WEBRTC_DEPENDENCIES ${CORE_FOUNDATION} ${APPLICATION_SERVICES} ${CORE_AUDIO} ${CORE_VIDEO} ${CORE_MEDIA}
            ${AUDIO_TOOLBOX} ${VIDEO_TOOLBOX} ${FOUNDATION})
